 ...
 * customized for Neruda Arts, to add ticket types (attributes) in the invoice
 */
?>

<table width="95%" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#660000" style="font-family: verdana, arial, helvetica; font-size: small;">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
			...
			<p><b><?php echo t('This email is your receipt.  Your email address will be on the guest list at the front door.  Enjoy the show!'); ?>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#660000" style="color: white;">
...
//							  drupal_set_message("<pre>".print_r($productnode)."</pre>");
              ...
              <tr>
                <td colspan="2">
                  ...
                  <p><?php echo t('Thanks again for shopping with Neruda Arts.'); ?></p>
                  <?php } ?>
